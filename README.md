**basil1989/laravel-user-verification** is a PHP package built for Laravel 5.* to
easily handle a user verification and validate the e-mail.

**This package is Laravel 5.8 compliant.**

| laravel/branch | [2.2](https://github.com/basil1989/laravel-user-verification/tree/2.2) | [3.0](https://github.com/basil1989/laravel-user-verification/tree/3.0) | [4.1](https://github.com/basil1989/laravel-user-verification/tree/4.1) | [5.0](https://github.com/basil1989/laravel-user-verification/tree/5.0) | [6.0](https://github.com/basil1989/laravel-user-verification/tree/6.0) | [7.0](https://github.com/basil1989/laravel-user-verification/tree/7.0) | [master](https://github.com/basil1989/laravel-user-verification/tree/master) |
|---------|-----|-----|-----|-----|-----|-----|--------|
| 5.0.*   |  x  |     |     |     |     |     |        |
| 5.1.*   |  x  |     |     |     |     |     |        |
| 5.2.*   |  x  |     |     |     |     |     |        |
...
require block of your composer.json file:
    ...
    {
        "require": {
            "basil1989/laravel-user-verification": "7.*"
        }
...
Or run the following command:
    ...
    composer require basil1989/laravel-user-verification
...
```PHP
basil1989\UserVerification\UserVerificationServiceProvider::class,
```

You may add the following `aliases` to your `config/app.php`:

```PHP
'UserVerification' => basil1989\UserVerification\Facades\UserVerification::class,
```

Publish the package config file by running the following command:

```
php artisan vendor:publish --provider="basil1989\UserVerification\UserVerificationServiceProvider" --tag="config"
```
...
```
php artisan migrate --path="/vendor/basil1989/laravel-user-verification/src/resources/migrations"
```
...
```
php artisan vendor:publish --provider="basil1989\UserVerification\UserVerificationServiceProvider" --tag="migrations"
```
...
protected $routeMiddleware = [
    // …
    'isVerified' => \basil1989\UserVerification\Middleware\IsVerified::class,
```
...
```
php artisan vendor:publish --provider="basil1989\UserVerification\UserVerificationServiceProvider" --tag="views"
```
...
`Bbasil1989\UserVerification\Traits\VerifiesUsers`

`basil1989\UserVerification\Traits\RedirectsUsers`

and:

`basil1989\UserVerification\Traits\UserVerification`
...
```
php artisan vendor:publish --provider="basil1989\UserVerification\UserVerificationServiceProvider" --tag="translations"
```
...
```PHP
    ...
    use basil1989\UserVerification\Traits\VerifiesUsers;
    use basil1989\UserVerification\Facades\UserVerification;
